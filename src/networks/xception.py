...
class TransferModel(nn.Module):
    ...
    def __init__(
        ...
        if modelchoice == "xception":
            ...
            def return_pytorch04_xception(pretrained=True):
                ...
                if pretrained:
                    ...
                    try:
                        ...
                        state_dict = torch.load("./src/weights/xception-b5690688.pth")
            ...
            modelchoice == "resnet50"
            or modelchoice == "resnet18"
            or modelchoice == "resnext"
            or modelchoice == "inceptionv3"
            or modelchoice == "efficientB5"
            or modelchoice == "efficientB7"
        ):
        ...
        if boolean:
            ...
            if not found:
                raise NotImplementedError(
                    "Layer not found, cant finetune!".format(layername)
                )
        else:
